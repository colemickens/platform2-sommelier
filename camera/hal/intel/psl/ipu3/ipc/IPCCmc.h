...
#ifndef PSL_IPU3_IPC_IPCCMC_H_
#define PSL_IPU3_IPC_IPCCMC_H_
#include <ia_types.h>
...
public:
    ...
    bool clientUnflattenInit(const cmc_init_params& params, ia_cmc_t** cmc, uintptr_t* cmcRemoteHandle);
