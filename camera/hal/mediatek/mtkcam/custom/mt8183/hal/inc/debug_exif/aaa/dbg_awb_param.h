 ...
 */
#ifndef CAMERA_HAL_MEDIATEK_MTKCAM_CUSTOM_MT8183_HAL_INC_DEBUG_EXIF_AAA_DBG_AWB_PARAM_H_
#define CAMERA_HAL_MEDIATEK_MTKCAM_CUSTOM_MT8183_HAL_INC_DEBUG_EXIF_AAA_DBG_AWB_PARAM_H_
...
#define AWB_DEBUG_TAG_VERSION_DP \
  ((AWB_DEBUG_TAG_SUBVERSION << 16) | AWB_DEBUG_TAG_VERSION)
...
#endif
#define DBG_AWB_PARENT_BLK_NUM_MAX_X \
  (DBG_AWB_WINDOW_NUM_MAX_X / DBG_AWB_PARENT_BLK_SIZE_X)
#define DBG_AWB_PARENT_BLK_NUM_MAX_Y \
  (DBG_AWB_WINDOW_NUM_MAX_Y / DBG_AWB_PARENT_BLK_SIZE_Y)
...
typedef struct {
  ...
  // Is strobe fired
  MINT32 i4IsStrobeFired;  // 0: strobe is not fired ==> do not draw light area
                           // of strobe
  // Parent block number
...
#ifdef _SUPPORT_PB_3X3_
  DBG_XY_COORDINATE_T
  rXY[DBG_AWB_PARENT_BLK_NUM_MAX_Y]
     [DBG_AWB_PARENT_BLK_NUM_MAX_X];  // XrYr of specified parent block
  MINT8
  i4ChildBlkNum[DBG_AWB_PARENT_BLK_NUM_MAX_Y]
               [DBG_AWB_PARENT_BLK_NUM_MAX_X];  // Child block number of
                                                // specified light source of
                                                // specified parent block
  MINT8 i4Light[DBG_AWB_PARENT_BLK_NUM_MAX_Y]
               [DBG_AWB_PARENT_BLK_NUM_MAX_X];  // Light source of specified
                                                // parent block
#else
  MINT32
  i4SumR[DBG_AWB_PARENT_BLK_NUM_MAX_Y]
        [DBG_AWB_PARENT_BLK_NUM_MAX_X];  // R summation of specified light
                                         // source of specified parent block
  MINT32
  i4SumG[DBG_AWB_PARENT_BLK_NUM_MAX_Y]
        [DBG_AWB_PARENT_BLK_NUM_MAX_X];  // G summation of specified light
                                         // source of specified parent block
  MINT32
  i4SumB[DBG_AWB_PARENT_BLK_NUM_MAX_Y]
        [DBG_AWB_PARENT_BLK_NUM_MAX_X];  // B summation of specified light
                                         // source of specified parent block
  MINT8
  i4ChildBlkNum[DBG_AWB_PARENT_BLK_NUM_MAX_Y]
               [DBG_AWB_PARENT_BLK_NUM_MAX_X];  // Child block number of
...
#endif  // CAMERA_HAL_MEDIATEK_MTKCAM_CUSTOM_MT8183_HAL_INC_DEBUG_EXIF_AAA_DBG_AWB_PARAM_H_
