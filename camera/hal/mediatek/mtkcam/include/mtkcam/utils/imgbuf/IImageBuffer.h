...
#ifndef CAMERA_HAL_MEDIATEK_MTKCAM_INCLUDE_MTKCAM_UTILS_IMGBUF_IIMAGEBUFFER_H_
#define CAMERA_HAL_MEDIATEK_MTKCAM_INCLUDE_MTKCAM_UTILS_IMGBUF_IIMAGEBUFFER_H_
//
 ...
 ******************************************************************************/
enum eCacheCtrl { eCACHECTRL_FLUSH = 0, eCACHECTRL_INVALID = 1 };
...
enum eColorProfile {
  ...
  eCOLORPROFILE_BT709_LIMITED,
  eCOLORPROFILE_BT709_FULL,
  eCOLORPROFILE_BT2020_LIMITED,
  eCOLORPROFILE_BT2020_FULL,
  eCOLORPROFILE_JPEG
};
...
class IImageBuffer {
 ...
 public:  ////                    Image Attributes.
  ...
  virtual MVOID setColorProfile(eColorProfile profile) = 0;
  virtual eColorProfile getColorProfile() const = 0;
 ...
 public:  ////                    Cache.
  virtual MBOOL syncCache(eCacheCtrl const ctrl = eCACHECTRL_FLUSH) = 0;
 ...
 public:  ////                    Fence Operations.
  ...
  virtual MBOOL updateInfo(MSize const& imgSize) = 0;
};
...
class IImageBufferHeap {
 ...
 public:  ////                    Cache.
  virtual MBOOL syncCache(eCacheCtrl const ctrl) = 0;
 ...
 public:  ////
  ...
  virtual std::shared_ptr<IImageBuffer> createImageBuffer_FromBlobHeap(
      size_t offsetInBytes, size_t sizeInBytes) = 0;
 ...
 ******************************************************************************/
class VISIBILITY_PUBLIC IImageBufferAllocator {
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //  Definitions.
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 public:  ////                    Params for Allocations.
  struct ImgParam {
    ...
    size_t bufReusableSizeInBytes[3];  // the buffer size that caller wants to
                                       // reuse, usually use for vertical
                                       // padding, can be 0.
    MUINT32 colorProfile;
    MINT32 sensorOrder;
    //
    //  Image (width strides in bytes and minimum allocate size in byte).
    //  All T1 ,T2, T3 and T4 are expected to size_t.
    template <typename T1, typename T2, typename T3, typename T4>
    ImgParam(MINT32 const _imgFormat,
    ...
    ImgParam(MINT32 const _imgFormat,
             ...
             T2 const _bufBoundaryInBytes[],
             size_t const _planeCount,
             MINT32 const _colorProfile = eCOLORPROFILE_UNKNOWN,
             MINT32 const _sensorOrder = 0)
        : imgFormat(_imgFormat),
          imgSize(_imgSize),
          jpgSize(_imgSize),
          bufSize(0),
          colorProfile(_colorProfile),
          sensorOrder(_sensorOrder) {
      for (size_t i = 0; i < _planeCount; i++) {
        bufStridesInBytes[i] = _bufStridesInBytes[i];
        bufBoundaryInBytes[i] = _bufBoundaryInBytes[i];
    ...
    //
    //  BLOB memory.
    ImgParam(size_t const _bufSize,            // buffer size in bytes.
             size_t const _bufBoundaryInBytes  // the address will be a multiple
                                               // of boundary in bytes, which
    ...
    //
    //  JPEG memory.
    ImgParam(MSize const& _imgSize,            // image resolution in pixels.
  ...
  struct ExtraParam {
    ...
    MINT32 nocache;
    //
    ExtraParam(MINT32 _usage = eBUFFER_USAGE_SW_MASK | eBUFFER_USAGE_HW_MASK,
               MINT32 _nocache = 0)
  ...
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 public:  ////                    Operations.
  std::shared_ptr<IImageBuffer> alloc(
      char const* szCallerName,
      ImgParam const& rImgParam,
      ExtraParam const& rExtraParam = ExtraParam(),
      MBOOL const enableLog = MTRUE);

  std::shared_ptr<IImageBuffer> alloc_gbm(char const* szCallerName,
                                          ImgParam const& rImgParam,
                                          ExtraParam const& rExtraParam,
                                          MBOOL const enableLog = MTRUE);

  MVOID free(std::shared_ptr<IImageBuffer> pImageBuffer);
};

IImageBufferAllocator* VISIBILITY_PUBLIC getImageBufferAllocator();

/******************************************************************************
 *
 ******************************************************************************/
};      // namespace NSCam
#endif  // CAMERA_HAL_MEDIATEK_MTKCAM_INCLUDE_MTKCAM_UTILS_IMGBUF_IIMAGEBUFFER_H_
