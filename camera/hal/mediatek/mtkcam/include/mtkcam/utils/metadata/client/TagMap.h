...
#ifndef CAMERA_HAL_MEDIATEK_MTKCAM_INCLUDE_MTKCAM_UTILS_METADATA_CLIENT_TAGMAP_H_
#define CAMERA_HAL_MEDIATEK_MTKCAM_INCLUDE_MTKCAM_UTILS_METADATA_CLIENT_TAGMAP_H_
...
#define ADD_ALL_MEMBERS                                                        \
  ...
  _IMP_TAGCONVERT_(ANDROID_COLOR_CORRECTION_TRANSFORM,                         \
                   MTK_COLOR_CORRECTION_TRANSFORM)                             \
  _IMP_TAGCONVERT_(ANDROID_COLOR_CORRECTION_GAINS, MTK_COLOR_CORRECTION_GAINS) \
  _IMP_TAGCONVERT_(ANDROID_COLOR_CORRECTION_ABERRATION_MODE,                   \
                   MTK_COLOR_CORRECTION_ABERRATION_MODE)                       \
  _IMP_TAGCONVERT_(ANDROID_COLOR_CORRECTION_AVAILABLE_ABERRATION_MODES,        \
                   MTK_COLOR_CORRECTION_AVAILABLE_ABERRATION_MODES)            \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AE_ANTIBANDING_MODE,                        \
                   MTK_CONTROL_AE_ANTIBANDING_MODE)                            \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AE_EXPOSURE_COMPENSATION,                   \
  ...
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AE_TARGET_FPS_RANGE,                        \
                   MTK_CONTROL_AE_TARGET_FPS_RANGE)                            \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AE_PRECAPTURE_TRIGGER,                      \
  ...
  _IMP_TAGCONVERT_(ANDROID_CONTROL_VIDEO_STABILIZATION_MODE,                   \
                   MTK_CONTROL_VIDEO_STABILIZATION_MODE)                       \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AE_AVAILABLE_ANTIBANDING_MODES,             \
                   MTK_CONTROL_AE_AVAILABLE_ANTIBANDING_MODES)                 \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AE_AVAILABLE_MODES,                         \
                   MTK_CONTROL_AE_AVAILABLE_MODES)                             \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AE_AVAILABLE_TARGET_FPS_RANGES,             \
                   MTK_CONTROL_AE_AVAILABLE_TARGET_FPS_RANGES)                 \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AE_COMPENSATION_RANGE,                      \
                   MTK_CONTROL_AE_COMPENSATION_RANGE)                          \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AE_COMPENSATION_STEP,                       \
                   MTK_CONTROL_AE_COMPENSATION_STEP)                           \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AF_AVAILABLE_MODES,                         \
                   MTK_CONTROL_AF_AVAILABLE_MODES)                             \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AVAILABLE_EFFECTS,                          \
                   MTK_CONTROL_AVAILABLE_EFFECTS)                              \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AVAILABLE_SCENE_MODES,                      \
                   MTK_CONTROL_AVAILABLE_SCENE_MODES)                          \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AVAILABLE_VIDEO_STABILIZATION_MODES,        \
                   MTK_CONTROL_AVAILABLE_VIDEO_STABILIZATION_MODES)            \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AWB_AVAILABLE_MODES,                        \
                   MTK_CONTROL_AWB_AVAILABLE_MODES)                            \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_MAX_REGIONS, MTK_CONTROL_MAX_REGIONS)       \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_SCENE_MODE_OVERRIDES,                       \
                   MTK_CONTROL_SCENE_MODE_OVERRIDES)                           \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AE_PRECAPTURE_ID,                           \
  ...
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AVAILABLE_HIGH_SPEED_VIDEO_CONFIGURATIONS,  \
                   MTK_CONTROL_AVAILABLE_HIGH_SPEED_VIDEO_CONFIGURATIONS)      \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AE_LOCK_AVAILABLE,                          \
                   MTK_CONTROL_AE_LOCK_AVAILABLE)                              \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AWB_LOCK_AVAILABLE,                         \
                   MTK_CONTROL_AWB_LOCK_AVAILABLE)                             \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_AVAILABLE_MODES,                            \
                   MTK_CONTROL_AVAILABLE_MODES)                                \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_POST_RAW_SENSITIVITY_BOOST_RANGE,           \
                   MTK_CONTROL_POST_RAW_SENSITIVITY_BOOST_RANGE)               \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_POST_RAW_SENSITIVITY_BOOST,                 \
                   MTK_CONTROL_POST_RAW_SENSITIVITY_BOOST)                     \
  _IMP_TAGCONVERT_(ANDROID_CONTROL_ENABLE_ZSL, MTK_CONTROL_ENABLE_ZSL)         \
  ...
  _IMP_TAGCONVERT_(ANDROID_EDGE_AVAILABLE_EDGE_MODES,                          \
  ...
  _IMP_TAGCONVERT_(ANDROID_FLASH_COLOR_TEMPERATURE,                            \
  ...
  _IMP_TAGCONVERT_(ANDROID_JPEG_AVAILABLE_THUMBNAIL_SIZES,                     \
  ...
  _IMP_TAGCONVERT_(ANDROID_LENS_OPTICAL_STABILIZATION_MODE,                    \
  ...
  _IMP_TAGCONVERT_(ANDROID_LENS_INTRINSIC_CALIBRATION,                         \
                   MTK_LENS_INTRINSIC_CALIBRATION)                             \
  _IMP_TAGCONVERT_(ANDROID_LENS_RADIAL_DISTORTION, MTK_LENS_RADIAL_DISTORTION) \
  _IMP_TAGCONVERT_(ANDROID_LENS_INFO_AVAILABLE_APERTURES,                      \
                   MTK_LENS_INFO_AVAILABLE_APERTURES)                          \
  _IMP_TAGCONVERT_(ANDROID_LENS_INFO_AVAILABLE_FILTER_DENSITIES,               \
                   MTK_LENS_INFO_AVAILABLE_FILTER_DENSITIES)                   \
  _IMP_TAGCONVERT_(ANDROID_LENS_INFO_AVAILABLE_FOCAL_LENGTHS,                  \
                   MTK_LENS_INFO_AVAILABLE_FOCAL_LENGTHS)                      \
  _IMP_TAGCONVERT_(ANDROID_LENS_INFO_AVAILABLE_OPTICAL_STABILIZATION,          \
                   MTK_LENS_INFO_AVAILABLE_OPTICAL_STABILIZATION)              \
  _IMP_TAGCONVERT_(ANDROID_LENS_INFO_HYPERFOCAL_DISTANCE,                      \
                   MTK_LENS_INFO_HYPERFOCAL_DISTANCE)                          \
  _IMP_TAGCONVERT_(ANDROID_LENS_INFO_MINIMUM_FOCUS_DISTANCE,                   \
                   MTK_LENS_INFO_MINIMUM_FOCUS_DISTANCE)                       \
  _IMP_TAGCONVERT_(ANDROID_LENS_INFO_SHADING_MAP_SIZE,                         \
                   MTK_LENS_INFO_SHADING_MAP_SIZE)                             \
  _IMP_TAGCONVERT_(ANDROID_LENS_INFO_FOCUS_DISTANCE_CALIBRATION,               \
                   MTK_LENS_INFO_FOCUS_DISTANCE_CALIBRATION)                   \
  _IMP_TAGCONVERT_(ANDROID_NOISE_REDUCTION_MODE, MTK_NOISE_REDUCTION_MODE)     \
  _IMP_TAGCONVERT_(ANDROID_NOISE_REDUCTION_STRENGTH,                           \
                   MTK_NOISE_REDUCTION_STRENGTH)                               \
  _IMP_TAGCONVERT_(ANDROID_NOISE_REDUCTION_AVAILABLE_NOISE_REDUCTION_MODES,    \
                   MTK_NOISE_REDUCTION_AVAILABLE_NOISE_REDUCTION_MODES)        \
  _IMP_TAGCONVERT_(ANDROID_QUIRKS_METERING_CROP_REGION,                        \
                   MTK_QUIRKS_METERING_CROP_REGION)                            \
  _IMP_TAGCONVERT_(ANDROID_QUIRKS_TRIGGER_AF_WITH_AUTO,                        \
                   MTK_QUIRKS_TRIGGER_AF_WITH_AUTO)                            \
  _IMP_TAGCONVERT_(ANDROID_QUIRKS_USE_ZSL_FORMAT, MTK_QUIRKS_USE_ZSL_FORMAT)   \
  _IMP_TAGCONVERT_(ANDROID_QUIRKS_USE_PARTIAL_RESULT,                          \
  ...
  _IMP_TAGCONVERT_(ANDROID_REQUEST_MAX_NUM_OUTPUT_STREAMS,                     \
                   MTK_REQUEST_MAX_NUM_OUTPUT_STREAMS)                         \
  _IMP_TAGCONVERT_(ANDROID_REQUEST_MAX_NUM_REPROCESS_STREAMS,                  \
                   MTK_REQUEST_MAX_NUM_REPROCESS_STREAMS)                      \
  _IMP_TAGCONVERT_(ANDROID_REQUEST_MAX_NUM_INPUT_STREAMS,                      \
                   MTK_REQUEST_MAX_NUM_INPUT_STREAMS)                          \
  _IMP_TAGCONVERT_(ANDROID_REQUEST_PIPELINE_DEPTH, MTK_REQUEST_PIPELINE_DEPTH) \
  _IMP_TAGCONVERT_(ANDROID_REQUEST_PIPELINE_MAX_DEPTH,                         \
                   MTK_REQUEST_PIPELINE_MAX_DEPTH)                             \
  _IMP_TAGCONVERT_(ANDROID_REQUEST_PARTIAL_RESULT_COUNT,                       \
                   MTK_REQUEST_PARTIAL_RESULT_COUNT)                           \
  _IMP_TAGCONVERT_(ANDROID_REQUEST_AVAILABLE_CAPABILITIES,                     \
                   MTK_REQUEST_AVAILABLE_CAPABILITIES)                         \
  _IMP_TAGCONVERT_(ANDROID_REQUEST_AVAILABLE_REQUEST_KEYS,                     \
                   MTK_REQUEST_AVAILABLE_REQUEST_KEYS)                         \
  _IMP_TAGCONVERT_(ANDROID_REQUEST_AVAILABLE_RESULT_KEYS,                      \
                   MTK_REQUEST_AVAILABLE_RESULT_KEYS)                          \
  _IMP_TAGCONVERT_(ANDROID_REQUEST_AVAILABLE_CHARACTERISTICS_KEYS,             \
                   MTK_REQUEST_AVAILABLE_CHARACTERISTICS_KEYS)                 \
  _IMP_TAGCONVERT_(ANDROID_REQUEST_AVAILABLE_SESSION_KEYS,                     \
                   MTK_REQUEST_AVAILABLE_SESSION_KEYS)                         \
  _IMP_TAGCONVERT_(ANDROID_REQUEST_AVAILABLE_PHYSICAL_CAMERA_REQUEST_KEYS,     \
                   MTK_REQUEST_AVAILABLE_PHYSICAL_CAMERA_REQUEST_KEYS)         \
  _IMP_TAGCONVERT_(ANDROID_SCALER_CROP_REGION, MTK_SCALER_CROP_REGION)         \
  _IMP_TAGCONVERT_(ANDROID_SCALER_AVAILABLE_FORMATS,                           \
                   MTK_SCALER_AVAILABLE_FORMATS)                               \
  _IMP_TAGCONVERT_(ANDROID_SCALER_AVAILABLE_JPEG_MIN_DURATIONS,                \
                   MTK_SCALER_AVAILABLE_JPEG_MIN_DURATIONS)                    \
  _IMP_TAGCONVERT_(ANDROID_SCALER_AVAILABLE_JPEG_SIZES,                        \
                   MTK_SCALER_AVAILABLE_JPEG_SIZES)                            \
  _IMP_TAGCONVERT_(ANDROID_SCALER_AVAILABLE_MAX_DIGITAL_ZOOM,                  \
                   MTK_SCALER_AVAILABLE_MAX_DIGITAL_ZOOM)                      \
  _IMP_TAGCONVERT_(ANDROID_SCALER_AVAILABLE_PROCESSED_MIN_DURATIONS,           \
                   MTK_SCALER_AVAILABLE_PROCESSED_MIN_DURATIONS)               \
  _IMP_TAGCONVERT_(ANDROID_SCALER_AVAILABLE_PROCESSED_SIZES,                   \
                   MTK_SCALER_AVAILABLE_PROCESSED_SIZES)                       \
  _IMP_TAGCONVERT_(ANDROID_SCALER_AVAILABLE_RAW_MIN_DURATIONS,                 \
                   MTK_SCALER_AVAILABLE_RAW_MIN_DURATIONS)                     \
  _IMP_TAGCONVERT_(ANDROID_SCALER_AVAILABLE_RAW_SIZES,                         \
                   MTK_SCALER_AVAILABLE_RAW_SIZES)                             \
  _IMP_TAGCONVERT_(ANDROID_SCALER_AVAILABLE_INPUT_OUTPUT_FORMATS_MAP,          \
                   MTK_SCALER_AVAILABLE_INPUT_OUTPUT_FORMATS_MAP)              \
  _IMP_TAGCONVERT_(ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS,             \
                   MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS)                 \
  _IMP_TAGCONVERT_(ANDROID_SCALER_AVAILABLE_MIN_FRAME_DURATIONS,               \
                   MTK_SCALER_AVAILABLE_MIN_FRAME_DURATIONS)                   \
  _IMP_TAGCONVERT_(ANDROID_SCALER_AVAILABLE_STALL_DURATIONS,                   \
  ...
  _IMP_TAGCONVERT_(ANDROID_SENSOR_REFERENCE_ILLUMINANT1,                       \
                   MTK_SENSOR_REFERENCE_ILLUMINANT1)                           \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_REFERENCE_ILLUMINANT2,                       \
                   MTK_SENSOR_REFERENCE_ILLUMINANT2)                           \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_CALIBRATION_TRANSFORM1,                      \
                   MTK_SENSOR_CALIBRATION_TRANSFORM1)                          \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_CALIBRATION_TRANSFORM2,                      \
                   MTK_SENSOR_CALIBRATION_TRANSFORM2)                          \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_COLOR_TRANSFORM1,                            \
                   MTK_SENSOR_COLOR_TRANSFORM1)                                \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_COLOR_TRANSFORM2,                            \
  ...
  _IMP_TAGCONVERT_(ANDROID_SENSOR_BASE_GAIN_FACTOR,                            \
                   MTK_SENSOR_BASE_GAIN_FACTOR)                                \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_BLACK_LEVEL_PATTERN,                         \
                   MTK_SENSOR_BLACK_LEVEL_PATTERN)                             \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_MAX_ANALOG_SENSITIVITY,                      \
                   MTK_SENSOR_MAX_ANALOG_SENSITIVITY)                          \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_ORIENTATION, MTK_SENSOR_INFO_ORIENTATION)    \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_PROFILE_HUE_SAT_MAP_DIMENSIONS,              \
  ...
  _IMP_TAGCONVERT_(ANDROID_SENSOR_NEUTRAL_COLOR_POINT,                         \
                   MTK_SENSOR_NEUTRAL_COLOR_POINT)                             \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_NOISE_PROFILE, MTK_SENSOR_NOISE_PROFILE)     \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_PROFILE_HUE_SAT_MAP,                         \
                   MTK_SENSOR_PROFILE_HUE_SAT_MAP)                             \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_PROFILE_TONE_CURVE,                          \
                   MTK_SENSOR_PROFILE_TONE_CURVE)                              \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_GREEN_SPLIT, MTK_SENSOR_GREEN_SPLIT)         \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_TEST_PATTERN_DATA,                           \
                   MTK_SENSOR_TEST_PATTERN_DATA)                               \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_TEST_PATTERN_MODE,                           \
                   MTK_SENSOR_TEST_PATTERN_MODE)                               \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_AVAILABLE_TEST_PATTERN_MODES,                \
                   MTK_SENSOR_AVAILABLE_TEST_PATTERN_MODES)                    \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_ROLLING_SHUTTER_SKEW,                        \
                   MTK_SENSOR_ROLLING_SHUTTER_SKEW)                            \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_OPTICAL_BLACK_REGIONS,                       \
                   MTK_SENSOR_OPTICAL_BLACK_REGIONS)                           \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_DYNAMIC_BLACK_LEVEL,                         \
                   MTK_SENSOR_DYNAMIC_BLACK_LEVEL)                             \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_DYNAMIC_WHITE_LEVEL,                         \
                   MTK_SENSOR_DYNAMIC_WHITE_LEVEL)                             \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_OPAQUE_RAW_SIZE, MTK_SENSOR_OPAQUE_RAW_SIZE) \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_INFO_ACTIVE_ARRAY_SIZE,                      \
                   MTK_SENSOR_INFO_ACTIVE_ARRAY_REGION)                        \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_INFO_SENSITIVITY_RANGE,                      \
                   MTK_SENSOR_INFO_SENSITIVITY_RANGE)                          \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_INFO_COLOR_FILTER_ARRANGEMENT,               \
                   MTK_SENSOR_INFO_COLOR_FILTER_ARRANGEMENT)                   \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_INFO_EXPOSURE_TIME_RANGE,                    \
                   MTK_SENSOR_INFO_EXPOSURE_TIME_RANGE)                        \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_INFO_MAX_FRAME_DURATION,                     \
                   MTK_SENSOR_INFO_MAX_FRAME_DURATION)                         \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_INFO_PHYSICAL_SIZE,                          \
                   MTK_SENSOR_INFO_PHYSICAL_SIZE)                              \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_INFO_PIXEL_ARRAY_SIZE,                       \
                   MTK_SENSOR_INFO_PIXEL_ARRAY_SIZE)                           \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_INFO_WHITE_LEVEL,                            \
                   MTK_SENSOR_INFO_WHITE_LEVEL)                                \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_INFO_TIMESTAMP_SOURCE,                       \
                   MTK_SENSOR_INFO_TIMESTAMP_SOURCE)                           \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_INFO_LENS_SHADING_APPLIED,                   \
                   MTK_SENSOR_INFO_LENS_SHADING_APPLIED)                       \
  _IMP_TAGCONVERT_(ANDROID_SENSOR_INFO_PRE_CORRECTION_ACTIVE_ARRAY_SIZE,       \
  ...
  _IMP_TAGCONVERT_(ANDROID_SHADING_AVAILABLE_MODES,                            \
                   MTK_SHADING_AVAILABLE_MODES)                                \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_FACE_DETECT_MODE,                        \
                   MTK_STATISTICS_FACE_DETECT_MODE)                            \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_HISTOGRAM_MODE,                          \
                   MTK_STATISTICS_HISTOGRAM_MODE)                              \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_SHARPNESS_MAP_MODE,                      \
                   MTK_STATISTICS_SHARPNESS_MAP_MODE)                          \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_HOT_PIXEL_MAP_MODE,                      \
                   MTK_STATISTICS_HOT_PIXEL_MAP_MODE)                          \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_FACE_IDS, MTK_STATISTICS_FACE_IDS)       \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_FACE_LANDMARKS,                          \
                   MTK_STATISTICS_FACE_LANDMARKS)                              \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_FACE_RECTANGLES,                         \
  ...
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_SHARPNESS_MAP,                           \
                   MTK_STATISTICS_SHARPNESS_MAP)                               \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_LENS_SHADING_CORRECTION_MAP,             \
                   MTK_STATISTICS_LENS_SHADING_CORRECTION_MAP)                 \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_LENS_SHADING_MAP,                        \
                   MTK_STATISTICS_LENS_SHADING_MAP)                            \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_PREDICTED_COLOR_GAINS,                   \
                   MTK_STATISTICS_PREDICTED_COLOR_GAINS)                       \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_PREDICTED_COLOR_TRANSFORM,               \
                   MTK_STATISTICS_PREDICTED_COLOR_TRANSFORM)                   \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_SCENE_FLICKER,                           \
                   MTK_STATISTICS_SCENE_FLICKER)                               \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_HOT_PIXEL_MAP,                           \
                   MTK_STATISTICS_HOT_PIXEL_MAP)                               \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_LENS_SHADING_MAP_MODE,                   \
                   MTK_STATISTICS_LENS_SHADING_MAP_MODE)                       \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_INFO_AVAILABLE_FACE_DETECT_MODES,        \
                   MTK_STATISTICS_INFO_AVAILABLE_FACE_DETECT_MODES)            \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_INFO_HISTOGRAM_BUCKET_COUNT,             \
                   MTK_STATISTICS_INFO_HISTOGRAM_BUCKET_COUNT)                 \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_INFO_MAX_FACE_COUNT,                     \
                   MTK_STATISTICS_INFO_MAX_FACE_COUNT)                         \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_INFO_MAX_HISTOGRAM_COUNT,                \
                   MTK_STATISTICS_INFO_MAX_HISTOGRAM_COUNT)                    \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_INFO_MAX_SHARPNESS_MAP_VALUE,            \
                   MTK_STATISTICS_INFO_MAX_SHARPNESS_MAP_VALUE)                \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_INFO_SHARPNESS_MAP_SIZE,                 \
                   MTK_STATISTICS_INFO_SHARPNESS_MAP_SIZE)                     \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_INFO_AVAILABLE_HOT_PIXEL_MAP_MODES,      \
                   MTK_STATISTICS_INFO_AVAILABLE_HOT_PIXEL_MAP_MODES)          \
  _IMP_TAGCONVERT_(ANDROID_STATISTICS_INFO_AVAILABLE_LENS_SHADING_MAP_MODES,   \
  ...
  _IMP_TAGCONVERT_(ANDROID_TONEMAP_MAX_CURVE_POINTS,                           \
                   MTK_TONEMAP_MAX_CURVE_POINTS)                               \
  _IMP_TAGCONVERT_(ANDROID_TONEMAP_AVAILABLE_TONE_MAP_MODES,                   \
  ...
  _IMP_TAGCONVERT_(ANDROID_INFO_SUPPORTED_HARDWARE_LEVEL,                      \
  ...
  _IMP_TAGCONVERT_(ANDROID_REPROCESS_EFFECTIVE_EXPOSURE_FACTOR,                \
                   MTK_REPROCESS_EFFECTIVE_EXPOSURE_FACTOR)                    \
  _IMP_TAGCONVERT_(ANDROID_REPROCESS_MAX_CAPTURE_STALL,                        \
                   MTK_REPROCESS_MAX_CAPTURE_STALL)                            \
  _IMP_TAGCONVERT_(ANDROID_DEPTH_MAX_DEPTH_SAMPLES,                            \
                   MTK_DEPTH_MAX_DEPTH_SAMPLES)                                \
  _IMP_TAGCONVERT_(ANDROID_DEPTH_AVAILABLE_DEPTH_STREAM_CONFIGURATIONS,        \
                   MTK_DEPTH_AVAILABLE_DEPTH_STREAM_CONFIGURATIONS)            \
  _IMP_TAGCONVERT_(ANDROID_DEPTH_AVAILABLE_DEPTH_MIN_FRAME_DURATIONS,          \
                   MTK_DEPTH_AVAILABLE_DEPTH_MIN_FRAME_DURATIONS)              \
  _IMP_TAGCONVERT_(ANDROID_DEPTH_AVAILABLE_DEPTH_STALL_DURATIONS,              \
                   MTK_DEPTH_AVAILABLE_DEPTH_STALL_DURATIONS)                  \
  _IMP_TAGCONVERT_(ANDROID_DEPTH_DEPTH_IS_EXCLUSIVE,                           \
                   MTK_DEPTH_DEPTH_IS_EXCLUSIVE)                               \
  _IMP_TAGCONVERT_(ANDROID_LOGICAL_MULTI_CAMERA_PHYSICAL_IDS,                  \
                   MTK_LOGICAL_MULTI_CAMERA_PHYSICAL_IDS)                      \
  _IMP_TAGCONVERT_(ANDROID_LOGICAL_MULTI_CAMERA_SENSOR_SYNC_TYPE,              \
                   MTK_LOGICAL_MULTI_CAMERA_SENSOR_SYNC_TYPE)

#endif  // CAMERA_HAL_MEDIATEK_MTKCAM_INCLUDE_MTKCAM_UTILS_METADATA_CLIENT_TAGMAP_H_
