...
#ifndef CAMERA_HAL_MEDIATEK_MTKCAM_INCLUDE_MTKCAM_UTILS_METADATA_CLIENT_MTK_METADATA_TAG_H_
#define CAMERA_HAL_MEDIATEK_MTKCAM_INCLUDE_MTKCAM_UTILS_METADATA_CLIENT_MTK_METADATA_TAG_H_
...
typedef enum mtk_camera_metadata_section {
  ...
  MTK_REPROCESS,
  MTK_DEPTH,
  MTK_LOGICAL_MULTI_CAMERA,
  MTK_DISTORTION_CORRECTION,
  MTK_HAL_INFO,
  MTK_IOPIPE_INFO,
  MTK_SECTION_COUNT,
...
typedef enum mtk_camera_metadata_section_start {
  ...
  MTK_LOGICAL_MULTI_CAMERA_START = MTK_LOGICAL_MULTI_CAMERA << 16,
  MTK_DISTORTION_CORRECTION_START = MTK_DISTORTION_CORRECTION << 16,
  ...
  MTK_STEREO_FEATURE_START = (MTK_STEREO_FEATURE + MTK_VENDOR_TAG_SECTION)
                             << 16,
  MTK_HDR_FEATURE_START = (MTK_HDR_FEATURE + MTK_VENDOR_TAG_SECTION) << 16,
  MTK_MFNR_FEATURE_START = (MTK_MFNR_FEATURE + MTK_VENDOR_TAG_SECTION) << 16,
  MTK_CSHOT_FEATURE_START = (MTK_CSHOT_FEATURE + MTK_VENDOR_TAG_SECTION) << 16,
  MTK_3A_FEATURE_START = (MTK_3A_FEATURE + MTK_VENDOR_TAG_SECTION) << 16,
  MTK_EIS_FEATURE_START = (MTK_EIS_FEATURE + MTK_VENDOR_TAG_SECTION) << 16,
  MTK_STREAMING_FEATURE_START = (MTK_STREAMING_FEATURE + MTK_VENDOR_TAG_SECTION)
                                << 16,
  MTK_VSDOF_FEATURE_START = (MTK_VSDOF_FEATURE + MTK_VENDOR_TAG_SECTION) << 16,
  MTK_MULTI_CAM_FEATURE_START = (MTK_MULTI_CAM_FEATURE + MTK_VENDOR_TAG_SECTION)
                                << 16,
  MTK_CONTROL_CAPTURE_START = (MTK_CONTROL_CAPTURE + MTK_VENDOR_TAG_SECTION)
                              << 16,
  MTK_BGSERVICE_FEATURE_START = (MTK_BGSERVICE_FEATURE + MTK_VENDOR_TAG_SECTION)
                                << 16,
...
typedef enum mtk_camera_metadata_tag {
  ...
  MTK_REQUEST_AVAILABLE_SESSION_KEYS,  // int32[]      | ndk_public   | HIDL
                                       // v3.3
  MTK_REQUEST_AVAILABLE_PHYSICAL_CAMERA_REQUEST_KEYS,
  ...
  MTK_IOPIPE_INFO_AVAILABLE_IN_PORT_INFO = MTK_IOPIPE_INFO_START,
  ...
  MTK_STATISTICS_INFO_AVAILABLE_FACE_DETECT_MODES = MTK_STATISTICS_INFO_START,
  ...
  MTK_REPROCESS_EFFECTIVE_EXPOSURE_FACTOR = MTK_REPROCESS_START,
  ...
  MTK_LOGICAL_MULTI_CAMERA_PHYSICAL_IDS = MTK_LOGICAL_MULTI_CAMERA_START,
  MTK_LOGICAL_MULTI_CAMERA_SENSOR_SYNC_TYPE,
  MTK_LOGICAL_END,

  MTK_DISTORTION_CORRECTION_MODE =  // enum         | public       | HIDL v3.3
  MTK_DISTORTION_CORRECTION_START,
  MTK_DISTORTION_CORRECTION_AVAILABLE_MODES,  // byte[]       | public       |
                                              // HIDL v3.3
  MTK_DISTORTION_CORRECTION_END,
  ...
  MTK_FACE_FEATURE_POSE_ORIENTATIONS,
  ...
  MTK_HDR_FEATURE_SESSION_PARAM_HDR_MODE,  // control meta for config usage
  MTK_HDR_FEATURE_HDR_DETECTION_RESULT,    // Dynamic Meta, reply hdr detector
                                           // result
  MTK_HDR_FEATURE_AVAILABLE_HDR_MODES_PHOTO,  // Static Meta, for App query use,
                                              // runtime decided in
                                              // MetadataProvider
  MTK_HDR_FEATURE_AVAILABLE_HDR_MODES_VIDEO,  // Static Meta, for App query use,
                                              // runtime decided in
                                              // MetadataProvider
  MTK_HDR_FEATURE_AVAILABLE_VHDR_MODES,  // Static Meta, for middleware query
                                         // use
  MTK_HDR_FEATURE_AVAILABLE_SINGLE_FRAME_HDR,  // Static Meta, for middleware
                                               // query use
  MTK_HDR_FEATURE_END,

  // Dynamic Meta, middleware use, for override timestamp need or not use
  // [0] : need override or not
  // [1] : overrided or not. ( If overrided, can send shutter time to Framework)
  MTK_EIS_FEATURE_EIS_MODE = MTK_EIS_FEATURE_START,
  MTK_EIS_FEATURE_ISNEED_OVERRIDE_TIMESTAMP,
  MTK_EIS_FEATURE_NEW_SHUTTER_TIMESTAMP,  // Dynamic Meta, middleware use,
                                          // override timestamp for record
  MTK_EIS_FEATURE_END,

  MTK_STREAMING_FEATURE_RECORD_STATE =
      MTK_STREAMING_FEATURE_START,  // Control Meta, app use, tell recording or
                                    // stopping
  MTK_STREAMING_FEATURE_AVAILABLE_RECORD_STATES,  // Static Meta, for app query
                                                  // use
  ...
  MTK_STEREO_FEATURE_SHOT_MODE,
  MTK_STEREO_FEATURE_STATE,
  MTK_STEREO_FEATURE_END,

  MTK_MFNR_FEATURE_MFB_MODE = MTK_MFNR_FEATURE_START,
  MTK_MFNR_FEATURE_MFB_RESULT,
  MTK_MFNR_FEATURE_AVAILABLE_MFB_MODES,
  MTK_MFNR_FEATURE_AIS_MODE,
  MTK_MFNR_FEATURE_AIS_RESULT,
  MTK_MFNR_FEATURE_AVAILABLE_AIS_MODES,
  MTK_MFNR_FEATURE_END,

  MTK_CSHOT_FEATURE_AVAILABLE_MODES = MTK_CSHOT_FEATURE_START,
  MTK_CSHOT_FEATURE_CAPTURE,
  ...
  MTK_VSDOF_FEATURE_CALLBACK_BUFFERS = MTK_VSDOF_FEATURE_START,
  MTK_VSDOF_FEATURE_DENOISE_MODE,
  MTK_VSDOF_FEATURE_DENOISE_SUPPORTED_MODULE,
  MTK_VSDOF_FEATURE_3RDPARTY_MODE,
  MTK_VSDOF_FEATURE_3RDPARTY_SUPPORTED_MODULE,
  MTK_VSDOF_FEATURE_PREVIEW_ENABLE,
  MTK_VSDOF_FEATURE_SHOT_MODE,
  MTK_VSDOF_FEATURE_PREVIEW_SIZE,
  MTK_VSDOF_FEATURE_PREVIEW_MODE,            // full or half
  MTK_VSDOF_FEATURE_AVAILABLE_PREVIEW_MODE,  // for app static metadata use, and
                                             // it will set in metadata
                                             // provider.
  MTK_VSDOF_FEATURE_END,

  MTK_MULTI_CAM_FEATURE_MODE = MTK_MULTI_CAM_FEATURE_START,
  MTK_MULTI_CAM_FEATURE_AVAILABLE_MODE,  // for app static metadata use, and it
                                         // will set in metadata provider.
  ...
  MTK_CONTROL_CAPTURE_JPEG_FLIP_MODE,
  MTK_CONTROL_CAPTURE_AVAILABLE_POSTVIEW_MODES,
  MTK_CONTROL_CAPTURE_POSTVIEW_SIZE,
  MTK_CONTROL_CAPTURE_END,

  MTK_BGSERVICE_FEATURE_PRERELEASE_AVAILABLE_MODES =
...
} mtk_camera_metadata_enum_android_control_enable_zsl_t;
...
typedef enum mtk_camera_metadata_enum_android_request_available_capabilities {
  ...
  MTK_REQUEST_AVAILABLE_CAPABILITIES_MOTION_TRACKING,       // HIDL v3.3
  MTK_REQUEST_AVAILABLE_CAPABILITIES_LOGICAL_MULTI_CAMERA,  // HIDL v3.3
  MTK_REQUEST_AVAILABLE_CAPABILITIES_MONOCHROME,            // HIDL v3.3
...
} mtk_camera_metadata_enum_android_logic_multi_camera_sensor_sync_type_t;
// MTK_HAL_VERSION
#define MTKCAM_DEVICE_API_VERSION(maj, min) ((((maj)&0xff) << 8) | ((min)&0xff))

typedef enum mtk_camera_metadata_num_hal_version {
  MTK_HAL_VERSION_1_0 = MTKCAM_DEVICE_API_VERSION(1, 0),
  MTK_HAL_VERSION_3_0 = MTKCAM_DEVICE_API_VERSION(3, 0),
  MTK_HAL_VERSION_3_1 = MTKCAM_DEVICE_API_VERSION(3, 1),
  MTK_HAL_VERSION_3_2 = MTKCAM_DEVICE_API_VERSION(3, 2),
  MTK_HAL_VERSION_3_3 = MTKCAM_DEVICE_API_VERSION(3, 3),
  MTK_HAL_VERSION_3_4 = MTKCAM_DEVICE_API_VERSION(3, 4),
...
// MTK HDR
typedef enum mtk_camera_metadata_enum_hdr_mode {
  // Need align include/mtkcam/feature/hdrDetection/Defs.h
...
typedef enum mtk_camera_metadata_enum_vhdr_mode {
  // Need align include/mtkcam/drv/IHalSensor.h
...
typedef enum mtk_camera_metadata_enum_single_frame_hdr {
  MTK_HDR_FEATURE_SINGLE_FRAME_HDR_NOT_SUPPORTED = 0,
  MTK_HDR_FEATURE_SINGLE_FRAME_HDR_SUPPORTED = 1,
} mtk_camera_metadata_enum_single_frame_hdr_t;

// MTK_STEREO_FEATURE_STATE
typedef enum mtk_camera_metadata_enum_stereo_feature_status {
  MTK_STEREO_FEATURE_STATUS_OFF = 0,
  MTK_STEREO_FEATURE_STATUS_PREVIEW,
  MTK_STEREO_FEATURE_STATUS_CAPTURE,
  MTK_STEREO_FEATURE_STATUS_RECORD,
} mtk_camera_metadata_enum_stereo_feature_status_t;

// MTK MFB
typedef enum mtk_camera_metadata_enum_mfnr_mfb {
  MTK_MFNR_FEATURE_MFB_OFF = 0,
  MTK_MFNR_FEATURE_MFB_MFLL,
  MTK_MFNR_FEATURE_MFB_AIS,
  MTK_MFNR_FEATURE_MFB_AUTO = 0xFF,
} mtk_camera_metadata_enum_mfnr_mfb_t;

// MTK MFNR AIS
typedef enum mtk_camera_metadata_enum_mfnr_ais {
  MTK_MFNR_FEATURE_AIS_OFF = 0,
  MTK_MFNR_FEATURE_AIS_ON,
} mtk_camera_metadata_enum_mfnr_ais_t;

// MTK CShot
typedef enum mtk_camera_metadata_enum_cshot_mode {
  MTK_CSHOT_FEATURE_AVAILABLE_MODE_OFF = 0,
  MTK_CSHOT_FEATURE_AVAILABLE_MODE_ON,
} mtk_camera_metadata_enum_cshot_mode_t;

typedef enum mtk_camera_metadata_enum_cshot_capture {
  MTK_CSHOT_FEATURE_CAPTURE_OFF = 0,
  MTK_CSHOT_FEATURE_CAPTURE_ON,
} mtk_camera_metadata_enum_cshot_capture_t;

// postview
typedef enum mtk_camera_metadata_enum_control_capture_available_postview_modes {
  MTK_CONTROL_CAPTURE_POSTVIEW_MODE_OFF = 0,
  MTK_CONTROL_CAPTURE_POSTVIEW_MODE_ON,
} mtk_camera_metadata_enum_control_capture_available_postview_modes;

typedef enum mtk_camera_metadata_enum_control_capture_postview_size {
  MTK_CONTROL_CAPTURE_POSTVIEW_SIZE_WIDTH = 0,
  MTK_CONTROL_CAPTURE_POSTVIEW_SIZE_HEIGHT = 0,
...
} mtk_camera_metadata_enum_control_capture_early_notification_trigger;

typedef enum mtk_camera_metadata_enum_control_capture_early_next_ready {
  MTK_CONTROL_CAPTURE_EARLY_NOTIFICATION_NOT_READY = 0,
  MTK_CONTROL_CAPTURE_EARLY_NOTIFICATION_READY,
} mtk_camera_metadata_enum_control_capture_early_next_ready;

// Jpeg flip
typedef enum mtk_camera_metadata_enum_control_capture_jpeg_flip_mode {
  MTK_CONTROL_CAPTURE_JPEG_FLIP_MODE_OFF = 0,
  MTK_CONTROL_CAPTURE_JPEG_FLIP_MODE_ON,
} mtk_camera_metadata_enum_control_capture_jpeg_flip_mode;

// bgservice
typedef enum mtk_camera_metadata_enum_bgservice_prerelease_availablemode {
  MTK_BGSERVICE_FEATURE_PRERELEASE_MODE_OFF = 0,
  MTK_BGSERVICE_FEATURE_PRERELEASE_MODE_ON,
} mtk_camera_metadata_enum_bgservice_prerelease_availablemode;

typedef enum mtk_camera_metadata_enum_bgservice_prerelease {
  MTK_BGSERVICE_FEATURE_PRERELEASE_OFF = 0,
  MTK_BGSERVICE_FEATURE_PRERELEASE_ON,
} mtk_camera_metadata_enum_bgservice_prerelease;

// MTK EIS
typedef enum mtk_camera_metadata_enum_eis_mode {
  MTK_EIS_FEATURE_EIS_MODE_OFF = 0,
  MTK_EIS_FEATURE_EIS_MODE_ON = 1,
} mtk_camera_metadata_enum_eis_mode_t;

typedef enum mtk_camera_metadata_enum_record_state {
  // STATE_PREVIEW : It can be video preview
  // or recording stop state, decided by
  // has encode buffer or not
  MTK_STREAMING_FEATURE_RECORD_STATE_PREVIEW = 0,
  MTK_STREAMING_FEATURE_RECORD_STATE_RECORD,
} mtk_camera_metadata_enum_record_state_t;

// MTK_VSDOF_FEATURE_DENOISE_MODE
typedef enum mtk_camera_metadata_enum_vsdof_feature_denoise_mode {
  MTK_VSDOF_FEATURE_DENOISE_OFF = 0,
  MTK_VSDOF_FEATURE_DENOISE_ON,
} mtk_camera_metadata_enum_vsdof_feature_denoise_mode_t;

// MTK_VSDOF_FEATURE_3RDPARTY_MODE
typedef enum mtk_camera_metadata_enum_vsdof_feature_3rdparty_mode {
  MTK_VSDOF_FEATURE_3RDPARTY_OFF = 0,
  MTK_VSDOF_FEATURE_3RDPARTY_ON,
} mtk_camera_metadata_enum_vsdof_feature_3rdparty_mode_t;

// MTK_VSDOF_FEATURE_PREVIEW_ENABLE
typedef enum mtk_camera_metadata_enum_vsdof_feature_preview_enable {
  MTK_VSDOF_FEATURE_PREVIEW_OFF = 0,
  MTK_VSDOF_FEATURE_PREVIEW_ON,
...
} mtk_camera_metadata_enum_android_logicalmulticamera_sensor_sync_type_t;

// MTK_MULTI_CAM_FEATURE
typedef enum mtk_camera_metadata_enum_multi_cam_mode {
  MTK_MULTI_CAM_FEATURE_MODE_ZOOM = 0,
  MTK_MULTI_CAM_FEATURE_MODE_VSDOF,
  MTK_MULTI_CAM_FEATURE_MODE_DENOISE,
} mtk_camera_metadata_enum_multi_cam_mode_t;

// MTK_MULTI_CAM_FEATURE_PREVIEW_MODE
typedef enum mtk_camera_metadata_enum_vsdof_feature_preview_mode {
  MTK_VSDOF_FEATURE_PREVIEW_MODE_FULL = 0,
  MTK_VSDOF_FEATURE_PREVIEW_MODE_HALF,
} mtk_camera_metadata_enum_stereo_vsdof_preview_mode;

// ANDROID_DISTORTION_CORRECTION_MODE
typedef enum mtk_camera_metadata_enum_distortion_correction_mode {
  MTK_DISTORTION_CORRECTION_MODE_OFF,           // HIDL v3.3
  MTK_DISTORTION_CORRECTION_MODE_FAST,          // HIDL v3.3
  MTK_DISTORTION_CORRECTION_MODE_HIGH_QUALITY,  // HIDL v3.3
} mtk_camera_metadata_enum_distortion_correction_mode_t;

#endif  // CAMERA_HAL_MEDIATEK_MTKCAM_INCLUDE_MTKCAM_UTILS_METADATA_CLIENT_MTK_METADATA_TAG_H_
