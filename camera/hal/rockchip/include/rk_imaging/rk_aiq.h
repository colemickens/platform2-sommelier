...
typedef struct
{
    int manual_exposure_time_us_min;             /*!< Optional. Minimum exposure time in microseconds. -1 if NA. */
    int manual_exposure_time_us_max;             /*!< Optional. Maximum exposure time in microseconds. -1 if NA. */
