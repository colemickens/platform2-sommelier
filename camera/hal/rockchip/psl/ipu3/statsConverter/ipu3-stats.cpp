...
static void
ia_css_af_grid_config_ddr_decode(
    struct af_public_grid_config *to,
...
static void ia_css_awb_fr_grid_config_ddr_decode(
    struct awb_fr_public_grid_config *to,
...
static void
ia_css_ae_grid_config_ddr_decode(
    struct ae_public_config_grid_config *to,
        ...
        struct ia_css_4a_private_config *from)
{
    ...
    ia_css_awb_grid_config_ddr_decode(&to->awb_grd_config,
                                      &from->awb_config);
    ia_css_af_grid_config_ddr_decode(&to->af_grd_config,
                                     &from->af_config);
