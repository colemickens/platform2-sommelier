...
#ifndef LOGIN_MANAGER_SESSION_CONTAINERS_INTERFACE_H_
#define LOGIN_MANAGER_SESSION_CONTAINERS_INTERFACE_H_
...
#endif  // LOGIN_MANAGER_SESSION_CONTAINERS_INTERFACE_H_
