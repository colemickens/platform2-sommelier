...
#ifndef POWER_MANAGER_POWERD_MOCK_ACTIVITY_DETECTOR_H_
#define POWER_MANAGER_POWERD_MOCK_ACTIVITY_DETECTOR_H_
...
#endif  // POWER_MANAGER_POWERD_MOCK_ACTIVITY_DETECTOR_H_
