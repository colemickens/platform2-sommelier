...
extern const char kBatteryCurrentStabilizedAfterStartupMsPref[];
extern const char kBatteryCurrentStabilizedAfterPowerSourceChangeMsPref[];
extern const char kBatteryCurrentStabilizedAfterResumeMsPref[];
