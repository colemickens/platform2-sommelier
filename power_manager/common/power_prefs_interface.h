...
#ifndef POWER_MANAGER_COMMON_POWER_PREFS_INTERFACE_H_
#define POWER_MANAGER_COMMON_POWER_PREFS_INTERFACE_H_
...
#endif  // POWER_MANAGER_COMMON_POWER_PREFS_INTERFACE_H_
