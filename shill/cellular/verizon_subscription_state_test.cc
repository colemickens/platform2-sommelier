...
INSTANTIATE_TEST_CASE_P(
    ...
    testing::Values(
        ...
        vector<uint8_t>({0x27, 0x08, 0x00, 0xFF, 0x00, 0x04, 0xEE, 0x01, 0x84,
                         0x00}),
        vector<uint8_t>({0x27, 0x08, 0x00, 0xFF, 0x00, 0x04, 0x13, 0xEE, 0x84,
                         0x00}),
        vector<uint8_t>({0x27, 0x08, 0x00, 0xFF, 0x00, 0x04, 0x13, 0x01, 0xEE,
                         0x00}),
        vector<uint8_t>({
            // clang-format off
...
INSTANTIATE_TEST_CASE_P(
    ...
    testing::Values(make_tuple(vector<uint8_t>({0x27, 0x08, 0x00, 0xFF, 0x00,
                    ...
                    make_tuple(vector<uint8_t>({0x27, 0x08, 0x00, 0xFF, 0x00,
