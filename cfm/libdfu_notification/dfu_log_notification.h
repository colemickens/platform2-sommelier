...
#ifndef CFM_LIBDFU_NOTIFICATION_DFU_LOG_NOTIFICATION_H_
#define CFM_LIBDFU_NOTIFICATION_DFU_LOG_NOTIFICATION_H_
...
#endif  // CFM_LIBDFU_NOTIFICATION_DFU_LOG_NOTIFICATION_H_
