...
#ifndef CFM_LIBDFU_NOTIFICATION_IDFU_NOTIFICATION_H_
#define CFM_LIBDFU_NOTIFICATION_IDFU_NOTIFICATION_H_
...
#endif  // CFM_LIBDFU_NOTIFICATION_IDFU_NOTIFICATION_H_
