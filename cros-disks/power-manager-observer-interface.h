...
#ifndef CROS_DISKS_POWER_MANAGER_OBSERVER_INTERFACE_H_
#define CROS_DISKS_POWER_MANAGER_OBSERVER_INTERFACE_H_
...
class PowerManagerObserverInterface {
 public:
  virtual ~PowerManagerObserverInterface() {}
...
#endif  // CROS_DISKS_POWER_MANAGER_OBSERVER_INTERFACE_H_
