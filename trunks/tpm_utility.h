...
class TRUNKS_EXPORT TpmUtility {
 public:
  ...
  // |key_blob| is guaranteed to be the TPM2B_PUBLIC and TPM2B_PRIVATE structs
  // serialized and packed together. They can be extracted out by calling the
  // Parse_TPM2B_* methods in trunks.
  ...
  // serialized creation structures generated by the TPM. They will be
  // serialized in the following order:
  // 1) TPM2B_CREATION_DATA creation_data
  // 2) TPM2B_DIGEST creation_hash
  // 3) TPMT_TK_CREATION creation_ticket
