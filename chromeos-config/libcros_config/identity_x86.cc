...
bool CrosConfigIdentityX86::WriteFakeTables(base::File* smbios_file,
...
unsigned int CrosConfigIdentityX86::StringTableLength(const char* ptr) {
...
bool CrosConfigIdentityX86::FindAndCopyTable(enum SmbiosTypes type,
                                             const char* base_ptr,
                                             unsigned int size,
...
bool CrosConfigIdentityX86::GetSystemTable(const base::FilePath& smbios_file,
                                           SmbiosTable* table_out) {
...
std::string CrosConfigIdentityX86::GetSmbiosString(const SmbiosTable& table,
...
bool CrosConfigIdentityX86::ReadSmbios(
  ...
  name_ = GetSmbiosString(table, table.data.system.name);
