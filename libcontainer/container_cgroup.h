...
struct cgroup_ops {
  ...
  int (*add_device)(const struct container_cgroup* cg,
                    int allow,
                    int major,
                    int minor,
                    int read,
  ...
  int (*set_cpu_rt_runtime)(const struct container_cgroup* cg, int rt_runtime);
  int (*set_cpu_rt_period)(const struct container_cgroup* cg, int rt_period);
};
