...
BRILLO_EXPORT const char *
container_config_get_config_root(const struct container_config *c);
...
BRILLO_EXPORT const char *
container_config_get_pid_file(const struct container_config *c);
...
BRILLO_EXPORT const char *
container_config_get_program_arg(const struct container_config *c,
				 size_t index);
...
BRILLO_EXPORT int
container_config_alt_syscall_table(struct container_config *c,
 ...
 */
BRILLO_EXPORT int
container_config_add_mount(struct container_config *c, const char *name,
			   const char *source, const char *destination,
			   const char *type, const char *data,
			   const char *verity, int flags, int uid, int gid,
			   int mode, int mount_in_ns, int create, int loopback);
 ...
 */
BRILLO_EXPORT int container_config_add_device(
    struct container_config *c, char type, const char *path, int fs_permissions,
    int major, int minor, int copy_minor, int uid, int gid, int read_allowed,
    int write_allowed, int modify_allowed);
...
BRILLO_EXPORT int
container_config_set_cpu_cfs_params(struct container_config *c, int quota,
				    int period);
...
BRILLO_EXPORT int
container_config_get_cpu_rt_runtime(struct container_config *c);
BRILLO_EXPORT int
container_config_get_cpu_rt_period(struct container_config *c);
...
BRILLO_EXPORT const char *
container_config_get_cgroup_parent(struct container_config *c);

/* Enable sharing of the host's network namespace with the container */
BRILLO_EXPORT void
container_config_share_host_netns(struct container_config *c);
BRILLO_EXPORT int
get_container_config_share_host_netns(struct container_config *c);
 ...
 */
BRILLO_EXPORT void
container_config_set_securebits_skip_mask(struct container_config *c,
 ...
 */
BRILLO_EXPORT int
container_config_set_selinux_context(struct container_config *c,
				     const char *context);
 ...
 */
BRILLO_EXPORT void
container_config_set_pre_execve_hook(struct container_config *c,
