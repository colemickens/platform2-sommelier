...
DESCRIPTION:
   This function enumerates the QC WWAN devices currently attached to the
   system
...
DESCRIPTION:
   This function connects the CM API library to the specified QC WWAN 
   device
...
DESCRIPTION:
   This function returns the Node/key of the device the QC WWAN CM API library 
...
PARAMETERS:
   pSetting    [ O ] - NDIS autoconnect disabled (0) or enabled (1)
...
DESCRIPTION:
   This function enables/disables the NMEA sentence plus mode 
   callback function
...
RETURN VALUE:
   ULONG - Return code
===========================================================================*/
ULONG SetNMEAPlusCallback( tFNNewNMEAPlus pCallback );
