...
std::string ToString(P2PServerMessageType message_type) {
  switch (message_type) {
    case kP2PServerNumConnections:        return "NumConnections";
    case kP2PServerRequestResult:         return "RequestResult";
    case kP2PServerServedSuccessfullyMB:  return "ServedSuccessfullyMB";
    case kP2PServerServedInterruptedMB:   return "ServedInterruptedMB";
    case kP2PServerRangeBeginPercentage:  return "RangeBeginPercentage";
...
std::string ToString(P2PServerRequestResult request_result) {
  switch (request_result) {
    case kP2PRequestResultResponseSent:        return "ResponseSent";
    case kP2PRequestResultResponseInterrupted: return "ResponseInterrupted";
    case kP2PRequestResultMalformed:           return "Malformed";
    case kP2PRequestResultNotFound:            return "NotFound";
    case kP2PRequestResultIndex:               return "Index";

    case kNumP2PServerRequestResults:          return "Unknown";
    // Don't add a default case to let the compiler warn about newly added
    // message types which should be added here.
  }
  return "Unknown";
